...
public class SwitchboardPlugin implements Plugin {
    ...
    private static final SwitchboardPlugin instance = new SwitchboardPlugin();
     ...
     */
    public static SwitchboardPlugin instance() {
        return instance;
    }

    @Override
    public String name() {
        return SwitchboardPlugin.PROJECT_NAME;
    }

    @Override
    public String id() {
        return SwitchboardPlugin.PROJECT_ID;
    }
